...
4. **Dev stack** (semi-automated) — Claude Code follows `phase4.md` to install languages, runtimes, cloud CLIs, and containers
5. **Dotfiles** — Deploy personal config from the separate dotfiles repo
